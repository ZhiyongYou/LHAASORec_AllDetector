...
void WCDARec::core_likelihood()
{
	...
	/*	minuit->mnparm(0,"age",_age, 0.05,0,0,_flag);
		minuit->mnparm(1,"size",_size,0.01*kN30,0,0,_flag);*/
	minuit->mnparm(0,"age",_age,0.1,0.4,2.,_flag);
	minuit->mnparm(1,"size",_size,100,0.5*kN30,kN30*10000,_flag);
	minuit->mnparm(2,"cx",_cx,80,-400,400,_flag);
	minuit->mnparm(3,"cy",_cy,80,-400,400,_flag);
	/*minuit->mnparm(2,"cx",_cx,1,0,0,_flag);
	  minuit->mnparm(3,"cy",_cy,1,0,0,_flag);

	  minuit->SetFCN(NKG_FUNC);*/
	minuit->SetFCN(NKG_FUNCL);
	arglist[0]=1;
	...
	cout<<" 2aaqaaaaa "<<endl;
	minuit->GetParameter(0,vcore_like[0], vcore_like[1]);
	//minuit->GetParameter(1,vcore_like[2], vcore_like[3]);
	minuit->FixParameter(0);//age
	...
	cout<<" 3aaqaaaaa "<<endl;
	minuit->GetParameter(1,vcore_like[2], vcore_like[3]);
	minuit->GetParameter(2,vcore_like[4], vcore_like[5]);
	minuit->GetParameter(3,vcore_like[6], vcore_like[7]);
