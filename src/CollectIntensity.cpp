...
CollectIntensity::CollectIntensity()
{
	...
	//ReadIntensityFile("/lhaasofs/user/wangyd/SpotPWX/collection1/CollectIntensityWYD.root");
	ReadIntensityFile("/lhaasofs/user/wangyd/SpotPWX/collection1/CollectIntensity.root");
	std::cout << "================================ wfcta CollectIntensity constructor ================================" << std::endl;
}
...
int CollectIntensity::ReadIntensityFile(const char* filename)
{
	...
	char Name1[500]="root://eos01.ihep.ac.cn/";
	char infilename[500];
